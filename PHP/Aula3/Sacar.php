...
<body>
    <div class="container">
        <h2>Saque da sua conta</h2>
        <p>XiruBank o melhor</p>
        <form method="post" action="sacar.php">
            <input type="number" name="saldo" placeholder="Digite o valor que quer sacar">
            <input type="submit" name="add" value="Sacar">
        </form>
    </div>
    <?php
    include "Conta.php";
